...
export default function DevelopmentQuizPage() {
    ...
    fetch(apiUrl, {
      ...
      .then((data) => {
        ...
        const uniquePeriods = Array.from(
          new Set(
            (data.result || []).map((q: Quizdevelopment) => q.period.period)
          )
        ) as string[];
  ...
  async function handleDelete(quiz_id: number) {
    ...
    showConfirm("คุณต้องการลบคำถามนี้หรือไม่?", performDelete, {
      title: "ยืนยันการลบ",
      confirmText: "ลบ",
      severity: "error",
    });
                        ...
                        >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              console.log(
                                `Delete quiz with ID: ${quiz.quiz_id}`
                              );
                            }}
                          >
                            ลบ
