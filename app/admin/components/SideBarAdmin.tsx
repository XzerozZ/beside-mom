    ...
    <div className="w-64 bg-white h-screen flex flex-col sticky top-0">
      ...
      <div className="p-6 border-b flex-shrink-0">
        <div className="flex flex-row items-center">
          ...
          <div className="ml-2">
            <h2 className="text-xl text-black">{adminname}</h2>
          </div>
        </div>
      </div>
