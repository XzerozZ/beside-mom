    ...
    <nav className="bg-[#FFC6CF] flex justify-center fixed top-0 left-0 w-full z-999">
      <div className="flex flex-row justify-between h-[80px] w-[1312px] items-center max-xl:w-[770px] max-sm:w-[324px]">
        <div className="flex flex-row gap-4 items-center">
          ...
          <a href="/home" className="text-[20px] font-bold text-[#4D4D4D]">
            Beside Mom
          </a>
        </div>
        <div className="max-xl:hidden">
          <ul className="flex flex-row gap-[44px]">
            <li
              className={`text-[20px] hover:text-[#B36868] hover:font-bold ${
                isActive("/baby") ? "text-[#B36868] font-bold" : "text-black"
              }`}
            >
            ...
            <li
              className={`text-[20px] hover:text-[#B36868] hover:font-bold ${
                isActive("/story") ? "text-[#B36868] font-bold" : "text-black"
              }`}
            >
            ...
            <li
              className={`text-[20px] hover:text-[#B36868] hover:font-bold ${
                isActive("/care") ? "text-[#B36868] font-bold" : "text-black"
              }`}
            >
            ...
            <li
              className={`text-[20px] hover:text-[#B36868] hover:font-bold ${
                isActive("/contact") ? "text-[#B36868] font-bold" : "text-black"
              }`}
            >
      ...
      {showDropdown && (
        <div className="xl:hidden bg-[#FFEBEC] w-full h-screen fixed top-0 left-0 z-10">
            ...
            <div className="flex flex-row justify-between h-[80px] w-[1312px] items-center max-xl:w-[770px] max-sm:w-[324px]">
              <div className="flex flex-row gap-4 items-center">
                <Image
                  ...
                  alt="Logo"
                ></Image>
                <h1 className="text-[20px] font-bold text-[#4D4D4D]">
                  Beside Mom
                </h1>
              </div>
          ...
          <ul className="flex flex-col gap-4 p-4 z-10">
            ...
            <li
              className={`text-[20px] hover:text-[#B36868] hover:font-bold ${
                isActive("/profile") ? "text-[#B36868] font-bold" : "text-black"
              }`}
            >
